#!/usr/bin/env python3
# Credit: https://github.com/leosolid/qutebrowser-themes/blob/master/themes/onedark.py
...
bg_default = "#21242b"          # main shade darkest
bg_lighter = "#282c34"
bg_selection = "#3e4451"
...
bg_hint = "#ecbe7b"             # yellow
fg_matched_text = "#99bb66"     # green
bg_passthrough_mode = "#44b9b1" # teal
bg_insert_mode = "#51afef"      # blue
bg_warning = "#dd8844"          # orange
